...
function getAudience(assertion) {
	if (assertion.Conditions[0] && assertion.Conditions[0].AudienceRestriction[0] && assertion.Conditions[0].AudienceRestriction[0]) {
		return assertion.Conditions[0].AudienceRestriction[0].Audience[0];
	} else {
		return undefined;
	}
}
